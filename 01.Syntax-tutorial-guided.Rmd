...
These operators are used to combine the results of two or more relational operators into a single result. Here is the AND operator `&`:
...
For the OR operator the table would look as follows:
