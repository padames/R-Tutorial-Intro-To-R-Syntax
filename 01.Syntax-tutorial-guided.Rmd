...
<!-- ```{r quiz-1-c, echo=FALSE, cache=FALSE} quiz( question("What is the value of b -->
<!-- after executing the following R code? -->
<!-- a <- 5 -->
<!-- b <- a * (34 - 22) / 1 + 1", answer("12"), answer("30"), answer("61", correct = -->
<!-- TRUE), answer("149"), allow_retry = TRUE, random_answer_order = TRUE, try_again -->
<!-- = "Check the operator precedence table and try again." )) ``` -->
...
```{r quiz-1-b, echo=FALSE, cache=FALSE}
quiz(
  question("What is the result of executing
