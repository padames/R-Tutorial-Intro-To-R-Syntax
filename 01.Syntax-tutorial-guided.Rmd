...
What if we wanted a vector that recognized the distinct genres, furthermore what if we wanted it to provide automatic tracking of the number of songs of each genre on our play list. Introducing the factor object.
...
First let's turn the character vector into an actual factor object, an object of a different class.
