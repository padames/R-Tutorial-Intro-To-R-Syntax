...
quiz(
  question_checkbox("Your rent went up by 3%.
  ...
  How could you reflect that in R? (select all that apply)",
           ...
           answer("new_rent <- to_do * 1.03", correct = FALSE, message = 'The binary operator * accepts only numeric arguments, here you are passing a list and a double, only the second is a numeric.'),
           ...
           answer("to_do$payments <- to_do$payments['rent'] * 1.03", correct = FALSE, message = "I have to mention also that you could loose a reminder to pay insurance this month if you continue with the current selection(s)."),
           random_answer_order = TRUE,
           allow_retry = TRUE,
