...
typeof(vl)
# the presence of any zero or one coerces all elements to "numeric"
...
In general R will try to coerce the elements of a vector to the most general type possible, usually _character_.
