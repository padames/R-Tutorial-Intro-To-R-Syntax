...
```{r explain-logical-mask-2, exercise=T, exercise.lines=3, exercise.setup="explain-logical-mask-setup"}
...
```{r quiz-dataframes, echo=FALSE, cache=FALSE}
quiz(
  question_checkbox("Select all that apply)",
           answer("a", correct = TRUE),
           answer("b", correct = TRUE),
           answer("c", correct = FALSE, message = ''),
           answer("d", correct = FALSE, message = "."),
           answer("e", correct = FALSE, message = ")."),
           random_answer_order = TRUE,
           allow_retry = TRUE,
           correct = '!',
           incorrect = "!!")
