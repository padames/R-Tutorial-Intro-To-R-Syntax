...
Vectors of type `"character"`, `"numeric"`, `"logical"`, `"complex"`, or `"raw"` are always <span style="color:red">flat structures</span>, they can't have branches. They are called atomic  vectors.
...
The other case happens subsetting by a position that is out of the range of positions in the vector.
...
```{r, dataframe-sheat-sheet-example, echo=FALSE, results='asis'}
...
```{r example-dataframe-strings-as-factors, exercise=T, exercise.lines=7}
country <- c("Canada", "EEUU", "United Kingdom", "Germany", "Italy", "Poland")
population <- c(37, 331, 67, 83, 60, 39)
...
```{r example-dataframe-strings-as-is, exercise=T, exercise.lines=2, exercise.setup="example-dataframe-strings-as-is-setup"}
