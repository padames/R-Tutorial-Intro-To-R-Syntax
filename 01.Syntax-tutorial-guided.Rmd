...
Lists are one-dimensional data structures object that can store information of heterogeneous type, even other lists. R's well-known linear model object, with constructor `lm()`, is a list. Lists are very versatile and are at the center of R's data handling strength.
...
And here is your turn to create it in R code using the constructor `list()`. Try to complete the exercise before looking at the hint.
