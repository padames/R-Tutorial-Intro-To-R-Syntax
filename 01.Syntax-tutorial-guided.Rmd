...
quiz(
  ...
  question_checkbox("What piece of code inserts a2 into answers?
  ...
  Select all that apply.",
    answer("answers <- list(answers, a2)", correct = TRUE),
    answer("answers[[2]] <- a2", correct = TRUE),
    answer("answers <- c(answers, a2)", correct = FALSE, message = "c() combines several lists into one by breaking them up so it effectively flattens them, I think this doesn't achieve what the question asks."),
