...
Lists are one-dimensional data structures that can store information of heterogeneous type. R's well-known linear model object, with constructor `lm()`, is a list. Let's create a list  with the general constructor.
