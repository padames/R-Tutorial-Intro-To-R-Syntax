...
```{r number-functions-base-package, echo=T, message=FALSE, warning=FALSE}
# get the number of objects loaded from the base R package
length(builtins())
# The function 'match' is a builtin, it has a binary in-fix operator: %in%
# Use %in% to test if 'match' is part of the builtins
"match" %in% builtins()
```
