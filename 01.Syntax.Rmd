...
# add a new entry 
music_sample_2 <- c(music_sample_2, "Indie")
music_sample_2
```
...
country_name <- c("Canada", "EEUU", "United Kingdom", "Germany", "Italy", "Poland")
population_millions <- c(37, 331, 67, 83, 60, 39)
census_2019 <- c(T,T,T,T,F,T)
# the dot in names means nothing special in R, see note below for explanation
df <- data.frame(country.name = country_name,
                 population.millions = population_millions,
                 census.2019 = census_2019)
