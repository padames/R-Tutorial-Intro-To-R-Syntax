...
Start in order with every topic as they appear on the left panel. A check mark will appear to the left of each title when you have run all the code or answered the all the questions if the section is a quiz.
