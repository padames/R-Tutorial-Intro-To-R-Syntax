...
Undoubtedly too much for a 45-minute session. Therefore the focus will be on two aspects:
...
This section introduces the structural components used to write an R script. Because this is an introductory tutorial, semantics and tools will not be emphasized.

At its core, R represents everything as an object. Even functions and operators are an especial type of it in R. Programming languages model information by using objects called data structures. Let's go over the data structures, data types, and functions available in R to model information.
